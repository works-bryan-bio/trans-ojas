                    ...
                    <fieldset>        
                        <?php
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->input('thumbnail', ['class' => 'form-control', 'id' => 'thumbnail', 'label' => false]);                
                                    echo " </div></div>";    
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->input('is_publish', ['class' => 'form-control', 'id' => 'is_publish', 'label' => false]);                
                                    echo " </div></div>";    
