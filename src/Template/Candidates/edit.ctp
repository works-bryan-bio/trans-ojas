                    ...
                    <fieldset>  
                        ...
                        <?php
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                         echo $this->Form->input('birthdate', ['type' => 'text', 'value' => $candidate->birthdate->format("Y-m-d"), 'class' => 'form-control default-datepicker', 'id' => 'birthdate', 'label' => false, 'empty' => true]);                 
                                    echo " </div></div>";    
