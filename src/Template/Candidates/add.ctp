<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><?= $this->Html->link("<i class='fa fa-dashboard'></i>" . __('Candidates'), ['controller' => 'users', 'action' => 'dashboard'],['escape' => false]) ?></li>
                    ...
                    <fieldset>  
                        ...
                        <?php
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                         echo $this->Form->input('birthdate', ['type' => 'text', 'class' => 'form-control default-datepicker', 'id' => 'birthdate', 'label' => false, 'empty' => true]);                 
                                    echo " </div></div>";    
                                    ...
                                    <div class="callout callout-info">
                                        <h4 style="margin-left:20px;">Login Information</h4> 
                                    </div>
                                    ...
                                    <?php 
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class='col-sm-6'>";
                                            echo $this->Form->input('password', ['type' => 'password', 'class' => 'form-control', 'id' => 'password', 'required' => 'required', 'label' => false]);                
                                        echo " </div></div>";
                                    ?>
                    </fieldset>
