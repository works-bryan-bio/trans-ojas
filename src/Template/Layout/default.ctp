...
<header class="main-header">
    ...
    <a href="<?= $base_url; ?>" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><?= $this->Html->image('logo.png',["height"=>"20"]) ?></span>
      <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Transparency IT Consulting</b></span>  
    </a>
  ...
  <?php 
    if( $hdr_user_data->group_id == 1 ){
      ...
      include("menu_wrap_company.ctp"); 
    }else{
      include("menu_wrap_candidate.ctp"); 
    }
