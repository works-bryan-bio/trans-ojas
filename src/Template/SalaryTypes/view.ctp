...
<section class="content">   
    ...
    <div class="related">
        ...
        <?php if (!empty($salaryType->opportunities)): ?>
        <table class="table table-striped table-bordered table-hover">
            <tbody>
            <tr>
                <th><?= __('Id') ?></th>
                ...
                <th><?= __('Min Salary') ?></th>
                <th><?= __('Max Salary') ?></th>
                <th><?= __('Display Salary On Ads') ?></th>
                <th><?= __('Salary Details Displayed') ?></th>
                <th><?= __('Salary Type Id') ?></th>
                <th><?= __('Visit Count') ?></th>
                <th class="actions"><?= __('Actions') ?></th>
            </tr>
            <?php foreach ($salaryType->opportunities as $opportunities): ?>
            <tr>
                ...
                <td><?= h($opportunities->max_salary) ?></td>
                <td><?= h($opportunities->display_salary_on_ads) ?></td>
                <td><?= h($opportunities->salary_details_displayed) ?></td>
                <td><?= h($opportunities->salary_type_id) ?></td>
