                    ...
                    <fieldset>        
                        ...
                        <?php                                
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->input('publish_contact', ['class' => 'form-control', 'id' => 'publish_contact', 'default' => $opportunity->publish_contact, 'options' => [1 => 'Yes', 0 => 'No'], 'label' => false]);                
                                    echo " </div></div>";
                        ?>                        
