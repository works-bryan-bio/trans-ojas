<section class="content-header">
    <h1><?= __('Edit Industry Group') ?></h1>
    <ol class="breadcrumb">
        <li><?= $this->Html->link("<i class='fa fa-dashboard'></i>" . __("Home"), ['controller' => 'users', 'action' => 'dashboard'],['escape' => false]) ?></li>
        <li><?= $this->Html->link("<i class='fa fa-dashboard'></i>" . __('Industry Groups'), ['controller' => 'users', 'action' => 'dashboard'],['escape' => false]) ?></li>
    ...
    <div class="row">
        <section class="col-lg-12 ">
            <div class="box " >
                ...
                <div class="box-body">
                    <?= $this->Form->create($industryGroup,['id' => 'frm-default-add', 'data-toggle' => 'validator', 'role' => 'form','class' => 'form-horizontal']) ?>
                    <fieldset>        
                        <?php
                                                            echo "
                                    ...
                                    <div class='form-group'>
                                        ...
                                        <div class='col-sm-6'>";
                                        echo $this->Form->input('slug', ['class' => 'form-control', 'id' => 'slug', 'label' => false]);                
                                    echo " </div></div>";    
