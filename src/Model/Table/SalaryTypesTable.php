 ...
 * @method \App\Model\Entity\SalaryType newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\SalaryType[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\SalaryType|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\SalaryType patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\SalaryType[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\SalaryType findOrCreate($search, callable $callback = null)
 *
