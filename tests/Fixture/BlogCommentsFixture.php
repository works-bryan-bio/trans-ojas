...
class BlogCommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_public' => ['type' => 'integer', 'length' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'is_public' => 1,
            'created' => '2016-12-09 05:29:02',
            'modified' => '2016-12-09 05:29:02'
        ],
    ];
}
