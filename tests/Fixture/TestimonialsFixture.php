...
class TestimonialsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'position' => ['type' => 'string', 'length' => 180, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-12-08 14:58:50',
            'modified' => '2016-12-08 14:58:50'
        ],
    ];
}
