...
class CandidatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'string', 'length' => 30, 'null' => true, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-11-16 15:29:09',
            'modified' => '2016-11-16 15:29:09'
        ],
    ];
}
