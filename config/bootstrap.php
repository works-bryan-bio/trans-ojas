...
function companyGenerateUniqueId( $country_iso = "", $company_id = null ) {
    $cuid = "CO" . $country_iso . "-" . date("Y") . "-" . str_pad($company_id,3,0,STR_PAD_LEFT);
    return $cuid;
}

function candidateGenerateUniqueId( $country_iso = "", $candidate_id = null ) {
    $cuid = "CA" . $country_iso . "-" . date("Y") . "-" . str_pad($candidate_id,3,0,STR_PAD_LEFT);
    return $cuid;
}

function candidateGenerateUniqueIdNoIso( $candidate_id = null ) {
    $cuid = "CA" . "-" . date("Y") . "-" . str_pad($candidate_id,3,0,STR_PAD_LEFT);
    return $cuid;
}

function oppoGenerateUniqueId( $country_iso = "", $oppo_id = null ) {
    $cuid = $country_iso . "O" . "-" . date("Y") . "-" . str_pad($oppo_id,3,0,STR_PAD_LEFT);
    return $cuid;
}
...
function objectErrorsToString( $errors = array() ){
    $error_msg = [];
    $error_string = '';
